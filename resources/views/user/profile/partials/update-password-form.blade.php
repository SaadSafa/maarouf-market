<section>
    ...
    <div class="mt-6 profile-actions">
        <x-primary-button
            x-data=""
    ...
    <x-modal name="update-password" :show="$errors->updatePassword->isNotEmpty()" focusable>
        <form method="post" action="{{ route('password.update') }}" class="p-6 space-y-6 profile-form">
            @csrf
            @method('put')
            ...
            <div class="profile-field">
                ...
                @include('user.partials.password-requirements', ['inputId' => 'update_password_password'])
