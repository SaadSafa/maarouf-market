...
<div class="max-w-lg mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        <a href="{{ route('admin.sliders.index') }}" class="p-2 rounded-lg hover:bg-s
late-100">
        ...
        <div>
            <h1 class="text-2xl font-bold text-slate-900">Add Slider</h1>
            <p class="text-slate-500">Create a slider banner</p>
        </div>
    </div>
    ...
    <form action="{{ route('admin.sliders.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="flex justify-end">
            <button class="px-6 py-2.5 rounded-xl bg-emerald-600 text-white">Create</button>
        </div>
    </form>
